...
CREATE TABLE SEAT(
	TH_SEQ NUMBER NOT NULL,
	S1 VARCHAR2(3) NOT NULL,
	S2 VARCHAR2(3) NOT NULL,
	S3 VARCHAR2(3) NOT NULL,
	S4 VARCHAR2(3) NOT NULL,
	S5 VARCHAR2(3) NOT NULL,
	S6 VARCHAR2(3) NOT NULL,
	S7 VARCHAR2(3) NOT NULL,
	S8 VARCHAR2(3) NOT NULL,
	S9 VARCHAR2(3) NOT NULL,
	S10 VARCHAR2(3) NOT NULL
)
...
/*
--SEAT : 좌석 수 == row count 수 
CREATE TABLE SEAT(
	TH_SEQ NUMBER NOT NULL,
	S_NAME VARCHAR2(3) NOT NULL,
	S_YN NUMBER NOT NULL
)
*/

--부산행 극장
delete from seat where th_seq=11
